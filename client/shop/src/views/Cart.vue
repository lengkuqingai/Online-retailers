                        ...
                        <li v-for="(item,index) in cartList">
                            <div class="cart-tab-1">
                                <div class="cart-item-check">
                                    <a href="javascipt:;" class="checkbox-btn item-check-btn" v-bind:class="{'check':item.checked=='1'}" @click="changeNum('checked',item)">
                                ...
                                <div class="item-quantity">
                                    <div class="select-self select-self-open">
                                        <div class="select-self-area">
                                            <a class="input-sub" @click="changeNum('min',item)">-</a>
                                            <span class="select-ipt">{{item.productNum}}</span>
                                            <a class="input-add" @click="changeNum('max',item)">+</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="cart-foot-inner">
                    <div class="cart-foot-l">
                        <div class="item-all-check">
                            <a href="javascipt:;" @click="totalAll">
...
export default {
    ...
    methods:{
        ...
        del(item){
            axios.post('/users/del',{productId:item.productId}).then(res=>{
                this.getCart()
            })
        },
        checkout(){
